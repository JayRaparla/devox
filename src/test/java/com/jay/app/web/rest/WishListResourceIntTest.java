...
@SpringBootTest(classes = DevoxApp.class)
public class WishListResourceIntTest {
    ...
    public void createWishList() throws Exception {
        ...
        assertThat(testWishList.isIsPublic()).isEqualTo(DEFAULT_IS_PUBLIC);
    }
    ...
    public void updateWishList() throws Exception {
        ...
        assertThat(testWishList.isIsPublic()).isEqualTo(UPDATED_IS_PUBLIC);
    }
